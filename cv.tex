...
{}
{}
{{Développement, maintenance et exploitation des applications de l’entreprise :
\begin{itemize}%
  \item site internet www.grisbee.fr et application mobile ;
  \item application de suivi des relations clients ;
  \item programmes d’administration.
\end{itemize}}
Technologies utilisées :
\begin{itemize}%
  \item back-end : Groovy avec Grails et Gorm, serveur Tomcat ;
  \item front-end : GSP / jQuery, React Native, Less ;
  \item données : Mysql, MongoDB, Redis, Elasticsearch
\end{itemize}}
