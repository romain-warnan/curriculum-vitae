...
\quote{34 ans, marié, deux enfants}

% \quote{
%   J'ai découvert l'informatique en école d'ingénieur en statistiques.
%   La passion pour le développement ne m'a pas quitté depuis : cela fait 10 ans que je travaille dans ce domaine à l'Insee.
%   J'ai été maintenicien, puis \emph{lead-developer} et je suis aujourd'hui responsable d'un groupe de développeurs.
% }
